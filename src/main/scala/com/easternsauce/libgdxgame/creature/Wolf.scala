...
class Wolf private (override val id: String, override val body: Option[Body] = None)
  ...
  override def copy(
    ...
    val creature = Wolf(id = id, body = body)
...
object Wolf extends CreatureInfo {
  def apply(id: String, body: Option[Body] = None): Wolf = {
    val obj = new Wolf(id = id, body = body)
    obj.init()
    obj
  }
